    ...
    >
      ...
      <ul className="mt-[var(--space-9)] flex flex-col">
        {itens.map((item) => {
          ...
          return (
            <li key={item.id} className="relative border-t" style={{ borderColor: "var(--line)" }}>
              <motion.span
                aria-hidden
                      ...
                      <div className="grid-12 gap-y-[var(--space-6)]">
                        <div className="col-span-12 md:col-span-6">
                          <motion.p
                            ...
                            transition={{ delay: reduzido ? 0 : 0.14, duration: 0.5, ease: EASE_STANDARD }}
                          >
                            {item.summary}
                          </motion.p>
                          <TextoQueAcende texto={item.text} className="body mt-[var(--space-4)]" />
                        </div>
