    ...
    <div className="relative h-full w-full overflow-hidden" style={{ background: 'var(--bg)' }}>
      <span
        ...
        style={{
          ['--dur' as string]: '26s',
          backgroundImage:
            'repeating-radial-gradient(circle at 50% 50%, var(--text) 0 1.2px, transparent 1.2px 7px)',
        }}
      />
      <span
        ...
        style={{
          ...
          backgroundImage:
            'repeating-radial-gradient(circle at 50% 50%, var(--accent-2) 0 1.2px, transparent 1.2px 7px)',
          mixBlendMode: 'screen',
        }}
      />
    </div>
...
function Listras() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'repeating-linear-gradient(115deg, var(--text-2) 0 10px, var(--bg) 10px 20px, var(--accent) 20px 24px, var(--bg) 24px 42px)',
...
function Ascii() {
  ...
  return (
    <pre
      ...
      style={{ background: 'var(--surface-2)', color: 'var(--ice)' }}
    >
      {quadro || '···'}
    </pre>
  );
...
function Ruido() {
  return (
    <svg viewBox="0 0 200 140" preserveAspectRatio="none" className="h-full w-full" aria-hidden="true">
      ...
      <rect width="200" height="140" fill="var(--surface-2)" />
      <rect width="200" height="140" filter="url(#chuvisco)" opacity="0.3" />
      <rect width="200" height="4" fill="var(--accent)" opacity="0.85">
...
function Tipo() {
  return (
    ...
    >
      <span className="zine-titulo text-[clamp(1.6rem,5vw,3.4rem)] leading-none" style={{ color: 'var(--bg)' }}>
        ESTICA
      </span>
    </div>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'var(--bg)',
        backgroundImage:
          'linear-gradient(var(--text-2) 1px, transparent 1px), linear-gradient(90deg, var(--text-2) 1px, transparent 1px)',
...
function Gota() {
  return (
    <div className="flex h-full w-full items-center justify-center" style={{ background: 'var(--surface-2)' }}>
