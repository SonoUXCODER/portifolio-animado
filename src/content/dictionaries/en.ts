...
export const en: Dictionary = {
  "meta": {
    ...
    "description": "Portfolio of a full-stack developer and UX/UI designer based in Bern, Switzerland. Five products with the full case study, the stack running in production, and studies that run live.",
    "country": "Switzerland",
  ...
  "work": {
    ...
    "intro": "Five products, each one carried from the first conversation to the day someone who is not me opened it. Every one of them can be opened right here, running, without leaving this page.",
    "roleLabel": "Role",
    "stackLabel": "Stack",
    "yearLabel": "Year",
  ...
  "capabilities": {
    ...
    "intro": "Eight things, and only eight. A services page with twenty items does not say “I do everything”. It says nobody decided what this is.",
  ...
  "interludes": {
    ...
    "items": {
      "klio": {
        "title": "Klio",
        "caption": "The muse of history, holding a scroll. Every project starts the same way: someone needs a thing recorded before it disappears.",
        "technique": "Photogrammetry · mesh decimated to 6%"
      },
      "daphne": {
        "title": "Daphne",
        "caption": "She turns into a tree mid-escape. Which is roughly what happens to an idea between the sketch and the deploy. It arrives on the other side as something else.",
  ...
  "contact": {
    ...
    "howItWorks": "How it works: send me the problem in two lines. I answer within two days with what I would do, how long it takes and what it costs. No discovery call, no thirty-page proposal.",
    "basedIn": "Based in",
  ...
  "livePreview": {
    ...
    "blockedText": "Its security policy blocks embedding, which is the correct setting for a product that handles accounts and payments. I set it that way myself.",
  ...
  "projects": {
    "phobiacori": {
      ...
      "intro": "PHOBIACORI has been drawing strange creatures in ink since 2019 and selling them one direct message at a time. The store had to fit that way of working: small runs, packed by hand, nothing resembling a conveyor belt.",
      ...
      "challenge": "Selling art in small runs has nothing to do with running a generic shop. The catalogue changes every week, half the pieces are one of a kind, and a marketplace layout made her work look like factory stock. On top of that: no budget for a backend, and no appetite for a platform that takes a cut of every sale.",
      "approach": [
        {
          "step": "Research",
    ...
    "knifes-me": {
      ...
      "intro": "I started it because every link-in-bio tool looked like the same page wearing a different colour. Here the person picks the palette, the background, the music and the layout, and the result still reads as theirs, not as the template’s.",
      ...
      "challenge": "Real customisation is expensive in performance: every new theme becomes more CSS shipped to someone who only wanted to tap a link. The product had to let people change almost everything without making the public page slower for the visitor who changes nothing.",
      "approach": [
        {
          "step": "Research",
    ...
    "sandra-hair-salon": {
      ...
      "intro": "A salon in Buchs (SG) serves German, English and Portuguese across the same counter. The site had to do exactly that, without turning into three sites maintained by one person who does not write code.",
      ...
      "challenge": "The neighbourhood is trilingual. Translating afterwards, as a layer on top, always breaks something: a price renders wrong, a button overflows, someone lands on half a page in German. And the salon needed to change its own prices without opening a code editor.",
      "approach": [
        {
          "step": "Research",
    ...
    "thayse-marques": {
      ...
      "intro": "A Rio de Janeiro practice was receiving family, labour and social-security cases through the same phone number, with no context attached. The idea was to turn the first conversation inside out: the triage happens before the contact, not during it.",
      ...
      "challenge": "Everything arrived through one channel with no context. The lawyer spent the first half hour of every conversation working out what the case was even about, and a good share of those cases were not hers to take.",
      "approach": [
        {
          "step": "Research",
    ...
    "truffle-nb": {
      ...
      "intro": "Fresh truffle lasts days, not months. The site had to say what exists today and how long it takes to arrive, and nothing beyond that, because everything beyond that goes out of date faster than anyone can edit it.",
      ...
      "challenge": "Seasonal produce ages on screen. A static page still advertising a truffle that ran out three weeks ago is worse than having no page at all. It costs trust, and trust is the entire product when someone is spending CHF 200 on something they cannot see.",
      "approach": [
        {
          "step": "Research",
