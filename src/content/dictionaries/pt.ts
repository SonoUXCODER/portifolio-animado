...
export const pt: Dictionary = {
  "meta": {
    ...
    "description": "Portfólio de um desenvolvedor full-stack e designer de produto baseado em Berna, Suíça. Cinco produtos com o estudo de caso inteiro, a stack em produção, e estudos que rodam ao vivo.",
    "country": "Suíça",
  ...
  "work": {
    ...
    "intro": "Cinco produtos, cada um levado da primeira conversa até o dia em que alguém que não sou eu abriu. Todos podem ser abertos aqui mesmo, rodando, sem sair desta página.",
    "roleLabel": "Papel",
    "stackLabel": "Stack",
    "yearLabel": "Ano",
  ...
  "capabilities": {
    ...
    "intro": "Oito coisas, e só oito. Uma página de serviços com vinte itens não diz “faço tudo”. Diz que ninguém decidiu o que isto é.",
  ...
  "interludes": {
    ...
    "items": {
      "klio": {
        "title": "Klio",
        "caption": "A musa da história, segurando um rolo de papel. Todo projeto começa assim: alguém precisa registrar uma coisa antes que ela se perca.",
        "technique": "Fotogrametria · malha reduzida a 6%"
      },
      "daphne": {
        "title": "Daphne",
        "caption": "Ela vira árvore no meio da fuga. É mais ou menos o que acontece com uma ideia entre o rascunho e o deploy. Chega do outro lado sendo outra coisa.",
  ...
  "contact": {
    ...
    "howItWorks": "Como funciona: você manda o problema em duas linhas. Eu respondo em até dois dias com o que eu faria, quanto tempo leva e quanto custa. Sem reunião de descoberta, sem proposta de trinta páginas.",
    "basedIn": "Base",
  ...
  "livePreview": {
    ...
    "blockedText": "A política de segurança dele bloqueia embed, que é a configuração certa para um produto que lida com conta e pagamento. Fui eu que configurei assim.",
  ...
  "projects": {
    "phobiacori": {
      ...
      "intro": "A PHOBIACORI desenha bicho estranho a nanquim desde 2019 e vendia por mensagem direta, uma de cada vez. A loja tinha que caber nesse jeito de trabalhar: tiragem pequena, embalagem na mão, nada parecido com esteira.",
      ...
      "challenge": "Vender arte em tiragem pequena não tem nada a ver com tocar uma loja genérica. O catálogo muda toda semana, metade das peças é única, e um layout de marketplace fazia o trabalho dela parecer estoque de fábrica. Somado a isso: sem orçamento para backend, e sem paciência para uma plataforma que fica com uma parte de cada venda.",
      "approach": [
        {
          "step": "Pesquisa",
    ...
    "knifes-me": {
      ...
      "intro": "Comecei porque toda ferramenta de link na bio parecia a mesma página vestindo outra cor. Aqui a pessoa escolhe a paleta, o fundo, a música e o layout, e o resultado continua sendo dela, não do template.",
      ...
      "challenge": "Personalização de verdade custa caro em performance: cada tema novo vira mais CSS entregue a quem só queria tocar num link. O produto tinha que deixar mudar quase tudo sem deixar a página pública mais lenta para quem não muda nada.",
      "approach": [
        {
          "step": "Pesquisa",
    ...
    "sandra-hair-salon": {
      ...
      "intro": "Um salão em Buchs (SG) atende alemão, inglês e português no mesmo balcão. O site tinha que fazer exatamente isso, sem virar três sites mantidos por uma pessoa que não escreve código.",
      ...
      "challenge": "O bairro é trilíngue. Traduzir depois, como camada por cima, sempre quebra alguma coisa: o preço sai errado, o botão estoura, alguém cai em meia página em alemão. E o salão precisava mudar os próprios preços sem abrir editor de código.",
      "approach": [
        {
          "step": "Pesquisa",
    ...
    "thayse-marques": {
      ...
      "intro": "Um escritório no Rio recebia caso de família, trabalhista e previdenciário pelo mesmo número, sem contexto nenhum junto. A ideia foi virar a primeira conversa do avesso: a triagem acontece antes do contato, não durante.",
      ...
      "challenge": "Tudo chegava pelo mesmo canal, sem contexto. A advogada gastava a primeira meia hora de cada conversa descobrindo do que o caso se tratava, e boa parte deles nem era dela para pegar.",
      "approach": [
        {
          "step": "Pesquisa",
    ...
    "truffle-nb": {
      ...
      "intro": "Trufa fresca dura dias, não meses. O site tinha que dizer o que existe hoje e quanto tempo demora para chegar, e nada além disso, porque tudo além disso envelhece mais rápido do que alguém consegue editar.",
      ...
      "challenge": "Produto sazonal envelhece na tela. Uma página estática ainda anunciando uma trufa que acabou há três semanas é pior do que não ter página nenhuma. Custa confiança, e confiança é o produto inteiro quando alguém está gastando CHF 200 em algo que não pode ver.",
      "approach": [
        {
          "step": "Pesquisa",
