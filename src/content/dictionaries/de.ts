...
/* Copy do site em de. So o idioma da pagina atual chega ao navegador. */
export const de: Dictionary = {
  meta: {
    ...
    colophon:
      "Gesetzt in Archivo und Instrument Sans. Von Hand geschrieben in Next.js und TypeScript.",
  },
  ui: {
  ...
  sections: {
    about: {
      name: "Über mich",
      nav: "Über mich",
      note: "Eine Person, zwei Disziplinen",
    },
    work: {
      name: "Ausgewählte Arbeiten",
      nav: "Arbeiten",
      note: "Fünf Produkte, vom Start bis live",
    },
    capabilities: {
      name: "Leistungen",
      nav: "Leistungen",
      note: "Vom Bild zur Infrastruktur",
    },
    contact: {
      name: "Kontakt",
      nav: "Kontakt",
      note: "Wo das hier endet und etwas anfängt",
    },
  },
  hero: {
    ...
    proof:
      "Fünf Produkte im Produktivbetrieb. Du kannst jedes davon direkt hier öffnen, ohne die Seite zu verlassen.",
  ...
  manifesto: {
    ...
    chain: [
      {
        step: "Design",
        note: "Recherche, Flows, Interface. Entschieden, solange Ändern noch billig ist.",
      },
      {
        step: "System",
        note: "Tokens und Komponenten, damit der zweite Screen einen Bruchteil des ersten kostet.",
      },
      {
        step: "Build",
        note: "Von Hand geschrieben. Kein Baukasten, kein fertiges Theme, keine Übergabe zwischen zwei Leuten.",
      },
      {
        step: "Launch",
        note: "Domain, Metriken, und der erste Besuch von jemandem, der nicht ich bin.",
      },
    ],
    stats: {
  ...
  work: {
    ...
    statements: [
      {
        lines: ["Mit Absicht", "gestalten."],
        align: "left",
      },
      {
        lines: ["Mit Präzision", "bauen."],
        align: "right",
      },
    ],
  },
  capabilities: {
    lines: ["Was ich", "mache."],
    intro:
      "Acht Dinge, und nur acht. Eine Leistungsseite mit zwanzig Punkten sagt nicht „ich mache alles“. Sie sagt, dass niemand entschieden hat, was das hier ist.",
    ...
    items: {
      ...
      frontend: {
        ...
        deliverables: [
          "Interfaces mit React / Next.js",
          "Motion- und Scroll-Systeme",
          "Core Web Vitals",
          "WCAG 2.2 AA",
        ],
      },
      ...
      "creative-design": {
        ...
        summary:
          "Art Direction, Bildgestaltung und die Elemente, die einem Produkt ein Gesicht geben.",
        text: "Vor dem Interface steht eine visuelle Entscheidung: wonach das Ding aussieht. Referenz, Palette, Bildbearbeitung, Komposition. Ich mache das einzelne Stück und das System dahinter, damit das zehnte Bild wie das erste aussieht, ohne dass sich jemand erinnern muss, warum.",
        deliverables: [
          "Art Direction",
          "Bildgestaltung und Komposition",
          "Retusche und Bildbearbeitung",
          "Grafiken und Banner",
          "Visuelles Marken-Kit",
        ],
      },
      "social-media": {
        title: "Social Media",
        summary: "Karussells, Posts und visuelle Inhalte für den Feed, nicht fürs Portfolio.",
        text: "Ein Karussell ist ein Argument in Slides: Das erste Bild hält, die mittleren liefern, das letzte fragt nach etwas. Ich schreibe die Abfolge und gestalte die Frames als Vorlage, damit das Team sie nächste Woche ohne mich wiederholen kann.",
        deliverables: [
          "Karussells",
          "Posts und Stories",
          "Cover und Banner",
  ...
  projects: {
    phobiacori: {
      ...
      system: {
        ...
        type: [
          {
            role: "Display",
            note: "Plakatschnitt, nur in drei Grössen im Einsatz",
          },
          {
            role: "Technisch",
            note: "Preise, Lagerstatus, Bestellnummern",
          },
          {
            role: "Text",
            note: "Beschreibungen und Versandtexte",
          },
        ],
        components: [
          "Stück-Karte",
    ...
    "knifes-me": {
      ...
      system: {
        ...
        type: [
          {
            role: "Display",
            note: "Enge Laufweite, für Profilnamen",
          },
          {
            role: "Interface",
            note: "Editor-Labels, Formulare, Dashboard",
          },
          {
            role: "Technisch",
            note: "Slugs, Keys, Analytics-Zahlen",
          },
        ],
        components: [
          "Link-Block",
    ...
    "sandra-hair-salon": {
      ...
      system: {
        ...
        type: [
          {
            role: "Display",
            note: "Salonname und Abschnittstitel",
          },
          {
            role: "Text",
            note: "Leistungstexte in drei Sprachen",
          },
          {
            role: "Technisch",
            note: "CHF-Preise und Dauern, ausgerichtet",
          },
        ],
        components: [
          "Sprachumschalter",
    ...
    "thayse-marques": {
      ...
      badge: "Kundenprojekt",
      summary:
        "Eine Kanzleiseite, deren Formular den Fall liest und ins richtige Rechtsgebiet leitet.",
      intro:
      ...
      system: {
        ...
        type: [
          {
            role: "Display",
            note: "Namen der Rechtsgebiete und Schlagzeilen",
          },
          {
            role: "Text",
            note: "Langer juristischer Text, Zeilenmass 62ch",
          },
          {
            role: "Technisch",
            note: "Fristen, Artikelnummern, Daten",
          },
        ],
        components: [
          "Rechtsgebiets-Karte",
      ...
      gallery: [
        {
          alt: "Die ganze Kanzleiseite, von oben bis unten",
          caption: "Die ganze Seite, von oben bis unten",
        },
      ],
    },
    "truffle-nb": {
      ...
      system: {
        ...
        type: [
          {
            role: "Display",
            note: "Produktnamen, gross und luftig",
          },
          {
            role: "Text",
            note: "Herkunft, Gewicht, Lieferfenster",
          },
          {
            role: "Technisch",
            note: "Grammpreise und Lieferzeiten",
          },
        ],
        components: [
          "Produktkarte",
      ...
      gallery: [
        {
          alt: "Die ganze Seite von Truffle N.B. Tricolore",
          caption: "Nur was die Saison wirklich hat",
        },
      ],
    },
  },
