...
export const stack: Tool[] = [
  ...
  { label: 'CSS',        nota: 'onde eu passo o dia',         x: 44, y: 2,  rot: 3,  peso: 3, doodle: 'espiral', cor: 'var(--accent-2)' },
  { label: 'JAVASCRIPT', nota: 'a cola de tudo',              x: 66, y: 16, rot: -3, peso: 2, doodle: 'raio' },
  { label: 'TYPESCRIPT', nota: 'pra dormir tranquilo',        x: 12, y: 30, rot: 4,  peso: 3, doodle: 'triangulo', cor: 'var(--accent)' },
  { label: 'REACT',      nota: 'desde 2022',                  x: 52, y: 38, rot: -5, peso: 2, doodle: 'olho' },
  { label: 'NEXT.JS',    nota: 'o que roda este site',        x: 74, y: 48, rot: 2,  peso: 3, doodle: 'seta', cor: 'var(--accent-2)' },
  ...
  { label: 'FIGMA',      nota: 'penso antes de codar',        x: 44, y: 90, rot: 2,  peso: 3, doodle: 'coracao', cor: 'var(--accent)' },
];
